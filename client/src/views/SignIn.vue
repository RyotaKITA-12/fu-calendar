                ...
                <v-card width="400px" class="mx-auto mt-5  blue-grey--text text--darken-2">
                    ...
                    <v-card-text>
                        <v-form ref="form" v-model="valid" lazy-validation>
                            <v-text-field prepend-icon="mdi-email" label="Email" v-model="email" :rules="emailRules"
                                required />
                            ...
                            <v-alert style="text-align: center; margin-top: 30px" dense text type="success"
                                v-if="message">
                                {{ message }}
                            </v-alert>
                            <v-alert style="text-align: center; margin-top: 30px" dense outlined type="error"
                                elevation="1" v-if="errorMessage">
                                {{ errorMessage }}
                            </v-alert>
                        </v-form>
                    </v-card-text>
